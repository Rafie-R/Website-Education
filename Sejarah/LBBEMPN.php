...
<html lang="id">
  <head>
    ...
    <link rel="stylesheet" href="cs/style3.css" />
  </head>
  <body>
    <header id="start">
      <nav class="container">
      ...
      <div class="blog-layout">
        <div class="blog-posts">
          <article class="blog-post fade-in">
            ...
            >
              <h1>Tokoh Penjelajah dari Portugis, Spanyol, Belanda, Inggris</h1>
            ...
            <div
              ...
              style="padding-top: 0px;padding-bottom: 0px;"
            >
              <h1>Perjanjian Pelayaran dari Eropa ke Nusantara</h1>
              <!-- Portugis & Spanyol -->
              <div>
        ...
        <aside class="sidebar">
          <div class="widget">
            ...
            <ul>
              ...
              <li><a href="#JalurPelayaran">hello Pelayaran</a></li>
          </ul>
          </div>
